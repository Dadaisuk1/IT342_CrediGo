    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthFilter) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Customer APIs
                .requestMatchers("/api/users/topup").hasAuthority("ROLE_Customer")
                .requestMatchers("/api/users/wallet").hasAuthority("ROLE_Customer")
                .requestMatchers("/api/transactions/user/me").hasAuthority("ROLE_Customer")
