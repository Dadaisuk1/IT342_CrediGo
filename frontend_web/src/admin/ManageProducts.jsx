...
const ManageProducts = () => {
  ...
  const fetchProducts = async () => {
    try {
      ...
      const res = await fetch(`${API_BASE_URL}/products/getAllProducts`, {
  ...
  const toggleActiveStatus = async (id) => {
    try {
      const res = await fetch(`${API_BASE_URL}/products/deactivate/${id}`, {
        method: 'PUT',
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleUpdateSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch(`${API_BASE_URL}/products/updateProduct/${editForm.productid}`, {
        method: 'PUT',
        headers: {
